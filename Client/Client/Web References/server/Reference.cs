...
namespace CLient.server {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void registerTeacherAsync(string username, string password, string email, string pincode, string subject) {
            this.registerTeacherAsync(username, password, email, pincode, subject, null);
        }
        
        /// <remarks/>
        public void registerTeacherAsync(string username, string password, string email, string pincode, string subject, object userState) {
            ...
            this.InvokeAsync("registerTeacher", new object[] {
                        ...
                        email,
                        pincode,
                        subject}, this.registerTeacherOperationCompleted, userState);
        }
